%
% This script compares the numerical solution for the stress field
% for a dislocation array with the nonsingular analytical results 
% derived by Cai et. al. (2006).
% 
...
% are computed using Cai's formulas summed over an infinite periodic
% dislocation array using the formulas in 19-5 of Hirth & Lothe.
%
% Kevin T. Chu
